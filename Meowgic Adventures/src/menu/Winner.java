...
public class Winner {
	...
	public Winner() {
		this.root = new Group();
		this.scene = new Scene(root, Winner.WINDOW_WIDTH, Winner.WINDOW_HEIGHT, Color.BLACK);
		this.Icon = new Image("images/MewgicIcon.png");
		this.Background = new Image("images/WinBG.png");
		...
		this.canvas = new Canvas(Winner.WINDOW_WIDTH, Winner.WINDOW_HEIGHT);
		...
		this.media = new Media(new File("Music/Winner.mp3").toURI().toString());
	...
	public void DisplayHome() {
		...
		// Start Button
		this.BtnStart.setLayoutX(580);
		this.BtnStart.setLayoutY(420);

		// About Button
		this.BtnAbout.setLayoutX(10);
		this.BtnAbout.setLayoutY(420);
